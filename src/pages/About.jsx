...
import { ArrowRight, Award, Baby, CheckCircle, GraduationCap, HeartPulse, MapPin, Microscope, Play, ShieldCheck, Stethoscope, Users, ChevronDown } from 'lucide-react';
...
const faqData = [
  ...
  { q: 'Is it possible to get IVF treatment under Rs 100000?', a: 'Yes, In-Vitro Fertilization (IVF) is possible for under Rs 100000 in Kolkata with Dr. Rajeev Agarwal and his team of IVF Doctors who specialize in fertility management for infertility problems.' },
...
export default function About({ onBookClick }) {
  useSeo(getMetaForPath('/about-me'));
